        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="section-title">
                        <p>Network applications are everywhere. Any time you browse the Web, send an email message, or pop up
                            ...
                            For example, processes, signals, byte ordering, memory mapping, and dynamic storage allocation all play
                            important roles. There are new concepts to master as well. We will need to understand the basic clientserver programming model and how to write client-server programs that use the services provided by the
                            Internet. At the end, we will tie all of these ideas together by developing a small but functional Web server
                            that can serve both static and dynamic content with text and graphics to real Web browsers.</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row featured__filter">
                                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                                    <div class="featured__item">
                                        <a href="https://b-ok.asia/dl/3703898/310df8"><img src="img/np/4c41002a94028f7af36de2d7ba77c21b.jpg"></a>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 mix vegetables fastfood">
                                    <div class="featured__item">
                                        <a href="https://b-ok.asia/dl/4994709/362539"><img src="img/np/56c86f659e6de7e2335530d8e25306bd.jpg"></a>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 mix vegetables fresh-meat">
                                    <div class="featured__item">
                                        <a href="https://drive.google.com/file/d/16NectaYIlI1ouIyKDYo1FFfYjndqJ9gY/view?usp=sharing"><img src="img/np/Hands-On Network Programming with C.jpg"></a>
                                    </div>
                                </div>
