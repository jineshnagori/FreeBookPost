        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="section-title">
                        <p>Perl is an interpreted language, which means that your code can be run as is, without a compilation stage that creates a non portable executable program.

                            <br>Traditional compilers convert programs into machine language. When you run a Perl program, it's first compiled into a byte code, which is then converted ( as the program runs) into machine instructions. So it is not quite the same as shells, or Tcl, which are strictly interpreted without an intermediate representation.
                            
                            <br>It is also not like most versions of C or C++, which are compiled directly into a machine dependent format. It is somewhere in between, along with Python and awk and Emacs .elc files.</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row featured__filter">
                                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                                    <div class="featured__item">
                                        <a href="https://b-ok.asia/dl/3591180/ad3039"><img src="img/perl/5ad7e196e1ad768dd3bfd33bc2886b73.jpg"></a>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 mix vegetables fastfood">
                                    <div class="featured__item">
                                        <a href="https://b-ok.asia/dl/3610379/2479a1"><img src="img/perl/679aaf40c6220b63e09ba437d9583028.jpg"></a>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 mix vegetables fresh-meat">
                                    <div class="featured__item">
                                        <a href="https://b-ok.asia/dl/3420285/e0c9a4"><img src="img/perl/6c52aeaf29bc2338c91dce8d2a6fde22.jpg"></a>
                                    </div>
                                </div>
