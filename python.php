                ...
                <div class="col-lg-9">
                    ...
                    <div class="section-title">
                        <p> Python is an interpreted, high-level, general-purpose programming language. Created by Guido van Rossum and first released in 1991, Python's design philosophy emphasizes code readability with its notable use of significant whitespace. Its language constructs and object-oriented approach aim to help programmers write clear, logical code for small and large-scale projects.
                            ...
                            <br><br>
                            Python was conceived in the late 1980s as a successor to the ABC language. Python 2.0, released in 2000, introduced features like list comprehensions and a garbage collection system with reference counting.</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row featured__filter">
                                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                                    <div class="featured__item">
                                        <a href="https://drive.google.com/file/d/1A8gEyU_HLLQl1N0B_HOoo3TmPlisuTFu/view?usp=sharing"><img src="img/python/Python 3 For Absolute Beginners(FreeBookPost).PNG"></a>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 mix vegetables fastfood">
                                    <div class="featured__item">
                                        <a href="https://drive.google.com/file/d/1RWRHJI1Rpza9seoYhIRGmVaw4G26gOPh/view?usp=sharing"><img src="img/python/Python Crash Course A Hands-On, Project-Based Introduction to Programming by Eric Matthes (FreeBookPost).png"></a>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 mix vegetables fresh-meat">
                                    <div class="featured__item">
                                        <a href="https://drive.google.com/file/d/1Btw78kKIyQcIBkn3FU7xQp5rXxfoL_hd/view?usp=sharing"><img src="img/python/Python Crash Course, 2nd Edition A Hands-On, Project-Based Introduction to Programming by Eric Matthes (FreeBookPost).png"></a>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 mix fastfood oranges">
                                    <div class="featured__item">
                                        <a href="https://drive.google.com/file/d/1Tbt8YQjX_TBUpABsWmSmoaYQJ958JUgT/view?usp=sharing"><img src="img/python/python3_tutorial(FreeBookPost).png"></a>
                                    </div>
                                </div>
