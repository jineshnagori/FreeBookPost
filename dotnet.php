        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="section-title">
                        <p>NET is a free, cross-platform, open source developer platform for building many different types of applications. With . NET, you can use multiple languages, editors, and libraries to build for web, mobile, desktop, games, and IoT.<br>. NET (pronounced dot net) is a framework that provides a programming guidelines that can be used to develop a wide range of applications–––from web to mobile to Windows-based applications. ... NET framework can work with several programming languages such as C#, VB.NET, C++ and F#.</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row featured__filter">
                                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                                    <div class="featured__item">
                                        <a href="https://b-ok.asia/dl/5563961/7755e9"><img src="img/dotnet/87fae2d5088230438987d755d0295af7.jpg"></a>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 mix vegetables fastfood">
                                    <div class="featured__item">
                                        <a href="https://b-ok.asia/dl/5537016/192380"><img src="img/dotnet/Hands-On Software Architecture with Core 3.jpg"></a>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 mix vegetables fresh-meat">
                                    <div class="featured__item">
                                        <a href="https://b-ok.asia/dl/5398024/b1e728"><img src="img/dotnet/8c009c01d6a207ab9606cf26a9999e2d.jpg"></a>
                                    </div>
                                </div>
